...
namespace RoundedTB
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public DockMagnification dockMagnification;
        ...
        public MainWindow()
        {
            ...
            dockMagnification = new DockMagnification(this);
            ...
            // ── Dock Magnification ────────────────────────────────────────
            dockMagnificationCheckBox.IsChecked = activeSettings.DockMagnificationEnabled;
            dockMagnificationSlider.Value = Math.Round((activeSettings.DockMagnificationMaxScale - 1.0) * 100);
        ...
        public void ApplyButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            // ── Dock Magnification ────────────────────────────────────────
            activeSettings.DockMagnificationEnabled  = (bool)dockMagnificationCheckBox.IsChecked;
            activeSettings.DockMagnificationMaxScale = Math.Round(1.0 + dockMagnificationSlider.Value / 100.0, 2);
            dockMagnification.Enabled         = activeSettings.DockMagnificationEnabled;
            dockMagnification.MaxScale        = activeSettings.DockMagnificationMaxScale;
            dockMagnification.SmoothingFactor = activeSettings.DockMagnificationSmoothing;
            dockMagnification.InvalidateBaselines();
            if (activeSettings.DockMagnificationEnabled)
                dockMagnification.Start();
            else
                dockMagnification.Stop();
