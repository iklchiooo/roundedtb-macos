...
namespace RoundedTB
{
    public class Types
    {
        ...
        public class Settings
        {
            ...
            /// <summary>Enable macOS-style icon magnification on hover.</summary>
            public bool DockMagnificationEnabled { get; set; } = false;
            /// <summary>Peak scale factor (1.0 = no change, 1.7 = 70% bigger).</summary>
            public double DockMagnificationMaxScale { get; set; } = 1.7;
            /// <summary>Animation smoothing per frame (0.05 = slow/buttery, 0.25 = snappy).</summary>
            public double DockMagnificationSmoothing { get; set; } = 0.16;
        }
